...
(function () {
    ...
    var methods = {
        ...
        setLanguage: function(domain, useFullPaths, languages, expires, lang) {
            var newPath, newLanguage, pathName = window.location.pathname, langReg = /^\/[a-z]{2}\//i;
            ...
            // if lang is in url replace it
            if(pathName.match(langReg)){
                newPath = newPath != "" ? pathName.replace(langReg, newLanguage + "/") : pathName.replace(langReg, "");
            }
            else{
                newPath = newPath != "" ? newPath + pathName : pathName.substring(1);
            }
...
document.languageDetection({languages:[{code:"en",path:"",defaultLanguage:!0},{code:"fr",path:"fr"},{code:"it",path:"it"},{code:"de",path:"de"}]});
